...
export default function VoorwaardenPage() {
 ...
 <p style={p}>Gratis accounts ontvangen eenmalig 3 credits bij registratie. Deze gratis credits worden niet maandelijks bijgevuld. Abonnementen worden maandelijks gefactureerd en zijn maandelijks opzegbaar.</p>
