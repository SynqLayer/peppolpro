...
export default function GDPRPage() {
 ...
 <p style={{ fontSize: 13, color: "#475569", marginBottom: 32 }}>Laatst bijgewerkt: 8 september 2026</p>
 ...
 <li style={{ fontSize: 14, color: "#94a3b8", lineHeight: 1.8, marginBottom: 6 }}>PDOK/BAG Locatieserver — Adresvalidatie voor Nederlandse adressen</li>
 <li style={{ fontSize: 14, color: "#94a3b8", lineHeight: 1.8, marginBottom: 6 }}>EU VIES — BTW-nummercontrole via de Europese Commissie</li>
