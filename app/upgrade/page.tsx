...
export default function UpgradePage() {
 const plans = [PLANS.free, PLANS.verzenden_25, PLANS.verzenden_100, PLANS.monitoring, PLANS.monitoring_accountant];
 ...
 .plan-grid { display: grid; grid-template-columns: repeat(5, minmax(0, 1fr)); gap: 16px; }
