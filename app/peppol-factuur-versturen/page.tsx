...
export const metadata: Metadata = {
 ...
 description: "Maak een Peppol BIS 3.0 UBL-bestand zonder boekhoudpakket. Direct verzenden via Peppol is nog niet beschikbaar.",
...
export default function PeppolFactuurVersturenPage() {
 ...
 <p style={pStyle}>
 Peppol is een Europees netwerk van access points. Direct verzenden via PeppolPro is nog niet beschikbaar. Download de UBL en verstuur die via je eigen access point of boekhoudpakket.
 </p>
 ...
 {[
 { plan: "Gratis", prijs: "€0", detail: "3 UBL-generaties" },
 { plan: "Compleet", prijs: "€9/mnd", detail: "UBL-generatie en archief" },
 ...
 Account aanmaken, gegevens invullen, UBL downloaden. Direct verzenden via Peppol is nog niet beschikbaar.
 </p>
