...
export const STEPS = [
 ...
 { n: "03", icon: "📥", t: "Download UBL", d: "Download een Peppol BIS 3.0 UBL/XML-bestand. Verzenden kan via een bundel of als losse verzending zodra je klaar bent." },
];
...
export const FEATURES = [
 ...
 { icon: "📡", t: "Peppol-verzending", d: "Kies een verzendbundel of betaal €1,95 per losse verzending per factuur." },
...
export const PRICING = [
 ...
 { name: "Verzenden 25", price: "€12", period: "/maand", sub: "Voor actieve ondernemers", features: ["25 verzendingen inbegrepen", "€0,45 per extra verzending", "UBL-generatie en download", "Factuurhistorie"], cta: "Kies Verzenden 25", hl: true },
 { name: "Verzenden 100", price: "€39", period: "/maand", sub: "Voor hogere volumes", features: ["100 verzendingen inbegrepen", "€0,35 per extra verzending", "UBL-generatie en download", "Factuurhistorie"], cta: "Kies Verzenden 100", hl: false },
];
